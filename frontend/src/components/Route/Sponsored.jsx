...
const Sponsored = () => {
    return (
        <div
            className={`${styles.section} hidden sm:block bg-gradient-to-br from-[#F5F8FF] to-[#A0C1FF] py-10 px-5 mb-12 rounded-3xl shadow-lg`}
        >
            <div className="flex flex-wrap justify-center gap-8 w-full items-center">
                <div className="flex items-center">
                    <img
                        ...
                        alt="Sony"
                        className="w-[120px] object-contain rounded-xl shadow-md bg-white p-2"
                    />
                </div>
                <div className="flex items-center">
                    <img
